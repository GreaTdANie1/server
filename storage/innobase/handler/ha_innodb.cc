...
@param[in]      bf_trx          Brute force transaction or NULL
...
/** This function forces the victim transaction to abort. Aborting the
  ...
  @param handlerton   unused
  @param bf_thd       brute force THD asking for the abort
  @param victim_thd   victim THD to be aborted
  @param signal       signal victim ?*/
	...
	my_bool signal)
{
	...
	WSREP_DEBUG("abort transaction: signal %d BF: %s victim: %s victim conf: %d",
		    signal,
		    wsrep_thd_query(bf_thd),
